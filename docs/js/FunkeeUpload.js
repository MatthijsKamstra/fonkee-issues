...
class FunkeeUpload {
	constructor() {
		...
		window.document.addEventListener("DOMContentLoaded",function(event) {
			$global.console.log("FunkeeUpload - Dom ready");
			_gthis.init();
		});
	}
	init() {
		this.fileInput = window.document.getElementById("formFile");
		...
		this.fileInput.onchange = function(e) {
			...
			if(_gthis.fileInput.files.length > 0) {
				...
				$global.console.log("You chose: ",file.name);
				$global.console.log("Weight: ",file.size);
				$global.console.log("Type: ",file.type);
				console.log("src/FunkeeUpload.hx:39:",file);
				let tmp = "\"" + file.name + "\", type:\"" + file.type + "\" is ";
				let tmp1 = _gthis.bytesToSize(file.size);
				_gthis.previewText.innerText = tmp + tmp1;
				let fileReader = new FileReader();
				fileReader.onload = function() {
					console.log("src/FunkeeUpload.hx:46:",fileReader.result);
					_gthis.convertData(fileReader.result);
				};
	...
	convertData(content) {
		...
		console.log("src/FunkeeUpload.hx:56:",arr);
		...
		html += "</tbody>";
		html += "</table>";
		let csvTable = window.document.getElementById("csv-table");
	...
	static main() {
		let app = new FunkeeUpload();
	}
}
FunkeeUpload.__name__ = true;
class HxOverrides {
	static cca(s,index) {
...
//# sourceMappingURL=FunkeeUpload.js.map